...
<script type="text/javascript"src="${ctx}/js/system/consumable/add.js"></script>
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/consumable/addEntity.shtml">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入消耗品名称"
						name="ConsumableFormMap.cname" id="cname" required="required";>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc" placeholder="请输入设备的规格类型"
						name="ConsumableFormMap.specifications" id="specifications" required="required">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" required="required"
						placeholder="请输入单位" name="ConsumableFormMap.unit" id="unit">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入单价"
						name="ConsumableFormMap.price" id="price"  required="required">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入设备描述"
						name="ConsumableFormMap.remarks" id="remarks">
				</div>
			</div>
		</div>
