...
<script type="text/javascript" src="${ctx}/js/system/devicerepair/addRepairRecord.js">
</script>
...
<body>
 <form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/devicerepair/addRepairEntity.shtml" style="height:700px;">	
	<div>
		<table   style="height:360px; border-collapse: collapse;margin:auto;font-size: 18px;">
			<tbody>
				<tr>
					<td>设备编号：</td>
					<td><input type="text"  id="dnumber" name="deviceRepairFormMap.dnumber" readonly="readonly" style="width: 100%;"/></td>
					<td>&nbsp;&nbsp;&nbsp;设备名称：</td>
					<td><input type="text" id="dname" name="deviceRepairFormMap.dname" readonly="readonly" style="width: 100%;"/></td>
				</tr>
				<tr>
					<td>规格型号：</td>
					<td><input type="text" id="dstandard" readonly="readonly" /></td>
					<td>&nbsp;&nbsp;&nbsp;<input type="button" id="seldevice" value="选择设备"  style="font-size: 17px;color:black;"/></td>	
				</tr>
				<tr>
					<td>维修单号：</td>
					<td><input class=".input" type="text"  value="<自动生成>" readonly="readonly" style="width: 100%;"/></td>
					<td>&nbsp;&nbsp;&nbsp;维修人员：</td>
				...
				<tr>
					<td>开始时间：</td>
					<td><input id="start" name="deviceRepairFormMap.begintime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="点击选择开始时间" readonly="readonly" type="text"  style="width: 100%;color:black;"/></td>
					<td>&nbsp;&nbsp;&nbsp;结束时间：</td>
					<td><input id="stop" name="deviceRepairFormMap.stoptime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="点击选择结束时间" readonly="readonly" type="text"  style="width: 100%;color:black;"/></td>
				...
				<tr>
					...
					<td><textarea style="font-size: 18px;width: 266%;height: 150px;color:black;line-height:18px;
