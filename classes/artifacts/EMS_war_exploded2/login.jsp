		...
		<form id="loginform" name="loginform" class="form-vertical"
				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
							<td align="center" style="font-weight: bold;color: gray;">宝利特信息平台</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
							alt="Logo"></td>
					</tr>
				...
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly" style="background: #28b779"><img
							...
							style="height: 32px; margin-bottom: 0px;" value="admin"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_ly"><img
							...
							style="height: 32px; margin-bottom: 0px;" value="111111"/>
					</div>
				</div>
			</div>
			<div class="form-actions">
				<!-- <span class="pull-left" style="width: 33%"><a href="#"
					...
					<span class="pull-left" style="width: 33%"><a href="javascript:changePassword()"
					class="flip-link btn btn-info" id="to-recover">忘记密码？</a></span>
	...
	<script type="text/javascript">
		...
		function changePassword(){
			layer.open({
				...
				scrollbar: true,
				area : [ "30%", "30%" ],
				content : '${pageContext.servletContext.contextPath }/changePassword.shtml'
				}); 
