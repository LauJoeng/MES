...
<script type="text/javascript" src="${ctx}/js/system/deviceinspect/addInspectPlan.js">
</script>
...
<body>
 <form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/inspect/addInspectPlanEntity.shtml">	
	<div>
		<table   style="height:300px; border-collapse: collapse;font-size: 18px;">
			<tbody>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;计划名称:&nbsp;</td>
					<td><input class=".input" type="text" id="name" name="deviceInspectPlanFormMap.name" /></td>		
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;计划时间:&nbsp;</td>
					<td><input type="text" name="deviceInspectPlanFormMap.plantime" id="plantime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly" placeholder="请选择计划开始时间" /></td>
				</tr>	
				<tr>
					<td>&nbsp;&nbsp;&nbsp;点检人员:&nbsp;</td>
					<td><input type="text" style="color:black;width:73%;" name="deviceInspectPlanFormMap.inspectman" id="repairman"  readonly="readonly" /><input type="button"  id="selrpman" value="···"/></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;点检周期:&nbsp;</td>
					<td><input type="number" name="deviceInspectPlanFormMap.inspectcycle" id="inspectcycle" />天</td>
				</tr>	
				<tr>
					<td>&nbsp;&nbsp;&nbsp;计划状态:&nbsp;</td>
					<td>
