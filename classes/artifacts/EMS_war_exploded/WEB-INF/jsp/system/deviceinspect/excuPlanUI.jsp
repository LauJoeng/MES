...
<form id="form" name="form" class="form-horizontal" method="post"
	...
	<input type="hidden" class="form-control checkacc"
		   name="deviceWaitInspectFormMap.planid"	value="${waitInspectPlan.planid}"  id="id">
	<input type="hidden" class="form-control checkacc"
		   name="deviceWaitInspectFormMap.id"	value="${waitInspectPlan.id}" >
	<div>
		<table   style="height:500px; border-collapse: collapse;margin:auto;font-size: 18px;">
			...
			<tr>
				...
				<td>&nbsp;&nbsp;&nbsp;设备编号：</td>
				<td><input type="text"  value="${waitInspectPlan.dnumber}" readonly="readonly" style="width: 100%;"/></td>

			</tr>
			<tr>
				<td>设备名称：</td>
				<td><input type="text"  id="dname"   value="${waitInspectPlan.dname}" readonly="readonly" style="width: 100%;"/></td>
				<td>&nbsp;&nbsp;&nbsp;规格型号：</td>
			...
			<tr>
				<td>维护人员：</td>
				<td><input type="text" style="color:black;"  id="inspectman"  value="${waitInspectPlan.inspectman}" readonly="readonly"/><input type="button"  id="inspectmanbtn" value="···"/></td>
				<td>&nbsp;&nbsp;&nbsp;计划名称：</td>
			...
			<tr>
				<td>开始时间：</td>
				<td><input id="starts"  name="deviceWaitInspectFormMap.starttime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"type="text"  style="width: 100%;color:black;"/></td>
				<td>&nbsp;&nbsp;&nbsp;结束时间：</td>
				<td><input id="stops" name="deviceWaitInspectFormMap.endtime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"  style="width: 100%;color:black;"/></td>
				<td><input type="number" name="deviceWaitInspectFormMap.inspectfee" id="maintainfee" style="display: none;"></td>
			</tr>
			<tr>
				<td style="vertical-align: top;">点检过程：</td>
				<td><textarea style="font-size: 18px;width: 240%;height: 150px;color:black;line-height:18px;
        		border:2px solid #4876FF;" name="deviceWaitInspectFormMap.inspectprocess" id="inspectinfo"></textarea></td>
			</tr>
