...
<script type="text/javascript" src="${ctx}/js/system/audit/edit.js"></script>
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/audit/through.shtml">
		...
		<footer class="panel-footer text-right bg-light lter">
			<button type="submit" class="btn btn-success btn-s-xs">通过</button>
		</footer> </section>
	</form>
