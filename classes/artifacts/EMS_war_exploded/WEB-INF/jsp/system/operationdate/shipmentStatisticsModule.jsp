...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/operationdate/shipmentStatisticsModule.js"></script>
	...
	<div class="m-b-md">
		<form class="form-inline" role="form" id="searchForm"
			...
			<a href="javascript:grid.exportData('/operationData/selectShipmentModuleExport.shtml')" class="btn btn-info" id="search">导出excel</a>
		</form>
	</div>
