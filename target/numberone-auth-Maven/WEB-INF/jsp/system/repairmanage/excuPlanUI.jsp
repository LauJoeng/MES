...
<script type="text/javascript" src="${ctx}/js/system/repairmanage/excuPlan.js"></script>
	...
	<div>
		<table   style="height:500px; border-collapse: collapse;margin:auto;font-size: 18px;">
			<tbody>
				<tr>
					<td>设备类别：</td>
					<td><input class=".input" type="text"  value="${repairPlan.dtype}" readonly="readonly" style="width: 100%;"/></td>
					<td>&nbsp;&nbsp;&nbsp;设备编号：</td>
					<td><input type="text"  value="${repairPlan.dnumber}" readonly="readonly" style="width: 100%;"/></td>
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;规格型号：</td>
					<td><input type="text"  value="${repairPlan.dstandard}" readonly="readonly" style="width: 100%;"/></td>
					
				</tr>
				<tr>
					<td>所在部门：</td>
					<td><input type="text" value="${repairPlan.usedept}" readonly="readonly" style="width: 100%;"/></td>
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;维护周期：</td>
					<td><input type="number"  readonly="readonly" id="repaircycle" value="${repairPlan.repaircycle}"/>天</td>
				</tr>
        		...
        		border:2px solid #4876FF;" id="planinfo" >${repairPlan.planinfo}</textarea></td>
				</tr>
				<tr>
					<td>开始时间：</td>
					<td><input id="starts"  name="maintainRecordFormMap.starttime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${repairPlan.plantime}" type="text"  style="width: 100%;color:black;"/></td>
					<td>&nbsp;&nbsp;&nbsp;结束时间：</td>
					<td><input id="stops" name="maintainRecordFormMap.endtime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${repairPlan.plantime}" type="text"  style="width: 100%;color:black;"/></td>
