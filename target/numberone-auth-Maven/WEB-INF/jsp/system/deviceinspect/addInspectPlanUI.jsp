	...
	<div>
		<table   style="height:300px; border-collapse: collapse;font-size: 18px;">
			<tbody>
				...
				<tr>
					<td>&nbsp;&nbsp;&nbsp;计划时间:&nbsp;</td>
					<td><input type="text" name="deviceInspectPlanFormMap.plantime" id="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly" placeholder="请选择计划开始时间" /></td>		
				</tr>	
				<tr>
					<td>&nbsp;&nbsp;&nbsp;点检人员:&nbsp;</td>
